// src/features/roadmap/roadmap-page.tsx – Bản hoàn chỉnh, an toàn
import React, {
  useState,
  useMemo,
  useEffect,
...
import type { Roadmap, SortMode, DifficultyFilter } from "./roadmap-types";
...
export function RoadmapPage() {
  ...
  // Load data lần đầu và khi user thay đổi
  useEffect(() => {
    setLessons([]);
    setProgress([]);
    setAttempts([]);
  ...
  // Confetti khi hoàn thành bài mới
  useEffect(() => {
  ...
  // Build roadmaps từ dữ liệu thực
    ...
    <CodeNovaLayout>
      ...
      <div className="mx-auto max-w-6xl px-4 pt-10 pb-24">
              ...
              <div className="flex gap-1">
                {last7Days().map((d) => {
                  ...
                  return (
                    <div
                      key={d}
                      title={new Date(d).toLocaleDateString("vi-VN", {
                        weekday: "short",
                        day: "2-digit",
                      })}
          ...
          <div className="rounded-2xl border border-border bg-card/60 p-4 md:p-6 backdrop-blur">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="hidden sm:block">
                <CircularProgress
                  percent={
                    calculateProgress(activeRoadmap.modules).percent
                  }
                  size={64}
                  stroke={5}
                />
        ...
        <div className="mt-8 text-center text-[11px] text-muted-foreground">
          Mẹo: dùng phím{" "}
          <kbd className="rounded bg-secondary px-1.5 py-0.5">j</kbd>{" "}
