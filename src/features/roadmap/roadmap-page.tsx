// src/features/roadmap/roadmap-page.tsx (HOÀN CHỈNH)
import React, {
  useState,
  useMemo,
  useEffect,
...
import { progressStore, progressEvents } from "@/lib/progress-store";
...
export function RoadmapPage() {
  ...
  useEffect(() => {
    ...
    const onStorage = (e: StorageEvent) => {
      if (!e.key || e.key.includes("progress") || e.key.includes("lesson")) reload();
    };
  ...
  useEffect(() => {
    ...
    if (prevCompletedCount.current !== null && completedNow > prevCompletedCount.current) {
